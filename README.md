...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/fancy-sound-6ebc
```

A live public deployment of this template is available at [https://fancy-sound-6ebc.templates.workers.dev](https://fancy-sound-6ebc.templates.workers.dev)
